...
export const FamilyVoiceView: React.FC = () => {
  ...
  const startSentencesNarration = (startIdx: number) => {
    ...
    const fallbackEmotionalSpeak = (sentence: string, currentIdx: number, _onComplete: () => void) => {
      let emotion: 'storyteller' | 'warm_mother' | 'warm_father' | 'gentle_grandma' = 'storyteller';
      let pitch = 1.18;
      let rate = 0.85;
      ...
      if (selectedSpeaker === 'cloned' && clonedProfile) {
        ...
        gender = clonedProfile.speaker === 'appa' ? 'male' : 'female';
        emotion = clonedProfile.speaker === 'appa' ? 'warm_father' : 'warm_mother';
      } else if (selectedSpeaker === 'appa') {
        emotion = 'warm_father';
        gender = 'male';
      } else if (selectedSpeaker === 'paati') {
      ...
      // Speak with rich emotional prosody and natural storytelling pauses!
                ...
                <div className="flex gap-1 flex-wrap justify-end">
                  ...
                  {clonedProfile ? (
                    ...
                    >
                      ...
                      <span>{clonedProfile.speakerLabelTa || clonedProfile.speakerLabelEn} (Your Voice)</span>
                    </button>
                  ) : (
                    <button
                      onClick={() => {
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`py-1 px-2 rounded-xl text-[10px] font-bold transition-all flex items-center gap-1 ${
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs font-black text-slate-900">
                        {clonedProfile.speakerLabelTa || clonedProfile.speakerLabelEn}
                      </span>
                    </div>
